...
const Features: FC = () => {
  ...
  const items = [
    { id: 1, icon: (
      <svg className="relative fill-gray-800" xmlns="http://www.w3.org/2000/svg" width="23" height="25">
    ...
    { id: 2, icon: (
      <svg className="relative fill-gray-800" xmlns="http://www.w3.org/2000/svg" width="22" height="22">
    ...
    { id: 3, icon: (
      <svg className="relative fill-gray-800" xmlns="http://www.w3.org/2000/svg" width="26" height="14">
  ...
  return (
    <section>
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 bg-white">
        {/* Illustration */}
        <div className="absolute inset-0 -z-10 -mx-28 rounded-t-[3rem] pointer-events-none overflow-hidden bg-gray-100" aria-hidden="true">
          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
                ...
                <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-gray-800/60 via-gray-800 to-gray-800/60 pb-3">Simplify your security with authentication services</h3>
                <p className="text-lg text-gray-600 mb-8">Define access roles for the end-users, and extend your authorization capabilities to implement dynamic access control.</p>
                <div className="mt-8 max-w-xs max-md:mx-auto space-y-2">
                  {items.map((item) => (
                    <button
                      key={item.id}
                      className={`flex items-center text-sm font-medium text-gray-900 rounded border bg-gray-100 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                        tab !== item.id ? 'border-gray-300 opacity-50' : 'border-blue-700 shadow shadow-blue-500/25'
                      }`}
                      onClick={() => setTab(item.id)}
                    >
                      <svg className="shrink-0 fill-gray-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <div className="relative w-48 h-48 flex justify-center items-center">
                      ...
                      <svg className="absolute inset-0 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 will-change-transform pointer-events-none blur-md" width="480" height="480" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                          <linearGradient id="pulse-a" x1="50%" x2="50%" y1="100%" y2="0%">
                            ...
                            <stop offset="76.382%" stopColor="#EFF6FF" />
                      ...
                      <div className="absolute inset-0 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none w-[500px] h-[500px] rounded-full overflow-hidden [mask-image:_radial-gradient(black,_transparent_60%)]">
                        <div className="h-[200%] animate-endless">
                          <div className="absolute inset-0 [background:_repeating-linear-gradient(transparent,_transparent_48px,_theme(colors.gray.200)_48px,_theme(colors.gray.200)_49px)] blur-[2px] opacity-20" />
                          ...
                          <div className="absolute inset-0 [background:_repeating-linear-gradient(90deg,transparent,_transparent_48px,_theme(colors.gray.200)_48px,_theme(colors.gray.200)_49px)] blur-[2px] opacity-20" />
