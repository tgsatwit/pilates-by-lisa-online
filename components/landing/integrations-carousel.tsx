...
export default function IntegrationsCarousel() {
  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div className="h-auto bg-gradient-to-tr from-slate-800 to-slate-800/25 rounded-3xl border border-slate-800 hover:border-slate-700/60 transition-colors group relative">
