...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh]">
      ...
      <div className="px-4 sm:px-6 pt-32 pb-12 md:pt-40 md:pb-20">
        <div className="max-w-3xl mx-auto text-left">
          ...
          <h1 
            className="h1 font-playfair-display text-4xl md:text-5xl lg:text-6xl mb-8 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60" 
            data-aos="fade-down"
          >
          ...
          <div 
            className="flex flex-col sm:flex-row justify-left space-y-4 sm:space-y-0 sm:space-x-4" 
            data-aos="fade-down" 
            data-aos-delay="400"
          >
            <a 
              className="btn text-slate-900 bg-white hover:bg-slate-100 w-full sm:w-auto"
              href="https://online.pilatesbylisa.com.au/browse"
            >
              Get Started
            </a>
            <button
              className="btn text-white bg-slate-800/30 hover:bg-slate-800/40 w-full sm:w-auto group"
