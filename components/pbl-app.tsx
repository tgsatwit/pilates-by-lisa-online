        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-12 md:py-20">
            ...
            <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
              ...
              <div className="md:absolute md:right-0 md:top-[-80px] -mb-12 mt-8 md:mt-0 md:mb-0">
                <div className="relative mx-4 md:mx-0">
                  <Image
                    ...
                    aria-hidden="true"
                  />
                  <div data-aos="fade-up" data-aos-anchor="[data-aos-id-2]" className="p-6 md:p-0">
                    <Image 
                      src={images[currentImageIndex]}
                      className="w-full md:w-[450px] transition-all duration-500 md:rotate-[5deg]"
                      width={775}
                      height={500}
                      priority
              ...
              <div className="md:max-w-lg">
                ...
                {/* Copy */}
                <h2 className="h2 h2 font-playfair-display text-white mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-2]" data-aos-delay="100">
                Anytime, Anywhere. Stream through any
                </h2>
                <p className="text-lg text-slate-100 mb-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-2]" data-aos-delay="200">
                Stream, purchase or gift workouts on-demand and workout on any device, through the web or our iOS app.
                </p>
                ...
                <div className="max-w-xs mx-auto sm:max-w-none mb-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-2]" data-aos-delay="300">
                  <div>
                  <a 
                    className="btn text-purple-900 bg-white hover:bg-slate-100 w-full sm:w-auto text-center text-md py-3 px-6"
