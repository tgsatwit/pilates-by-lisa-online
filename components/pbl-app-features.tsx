  ...
  return (
    <section className="relative bg-white">
      <div className="relative max-w-7xl mx-auto">
        {/* Bg */}
        <div className="absolute inset-0 rounded-tr-[100px] mb-24 md:mb-0 pointer-events-none bg-slate-50 -z-10" aria-hidden="true" />
              ...
              <div className="order-1 md:order-2 md:col-span-2 text-center">
                ...
                <div className="max-w-xs mx-auto sm:max-w-none mb-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-2]" data-aos-delay="300">
                  <div>
                    ...
                    >
                      Start Your Journey <span className="tracking-normal text-purple-200 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                    </a>
                  </div>
                </div>
